...
description: "How Cursor's background agent added C# support to Sentry with minimal prompting."
pubDate: 2025-07-07
...
![Original Prompt](~/assets/content/shipping-features-without-writing-code/original-prompt.png)
...
![Initial Agent Response](~/assets/content/shipping-features-without-writing-code/initial-agent-response.png)
...
![Followup Prompt](~/assets/content/shipping-features-without-writing-code/followup.png)
...
![Final Agent Response](~/assets/content/shipping-features-without-writing-code/result.png)
